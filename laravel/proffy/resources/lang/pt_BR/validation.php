...
return [
  ...
  */
  ...
  'custom' => [
    'taxonomy' => [
        'unique' => 'Taxonomia já existe.'
    ],
    'postalcode' => [
      'in_range' => 'Não pode estar em uma faixa de CEP existente.',
      'out_range' => 'Não pode englobar uma faixa de CEP existente.',
    ],
    'numeric' => [
      'after_or_equal' => 'Precisa ser maior ou igual a :compare.',
      'before_or_equal' => 'Precisa ser menor ou igual a :compare.'
    ]
  ],
